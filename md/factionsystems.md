...
Kuiper faction
    ...
    Gas Giant (high radiation)
        Floating Station/City
            Sells drinks and stolen stuff
        Moon with Vegetation
            Resource Gather Site
            Resource Gather Site
        Blue Moon (cyron element)
            Resource Gather Site
        Warp Gate Area
    ...
    Ice Planet - KUIPER FACTION CENTER
        Ground Station
        Moon with QUIRKY Traders
            Ground Station
    
    GNALL (Former Volcanic Planet)
        Obsidian and frozen igneous element 'elion'
            Gather Site
    ...
    Effects:
        Travel is restricted to vertical movement through ice belts - cannot traverse directly from innermost to outermost regions.